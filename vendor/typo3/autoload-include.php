...
if (!getenv('TYPO3_PATH_ROOT')) {
    putenv('TYPO3_PATH_ROOT=' . dirname(dirname(__DIR__)));
    $_ENV['TYPO3_PATH_ROOT'] = dirname(dirname(__DIR__));
}
if (!getenv('TYPO3_PATH_WEB')) {
    putenv('TYPO3_PATH_WEB=' . dirname(dirname(__DIR__)));
    $_ENV['TYPO3_PATH_WEB'] = dirname(dirname(__DIR__));
}
